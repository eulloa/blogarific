$(function(){
    ...
    $('span.follow, span.unfollow').on('click', function() {
        let id = $(this).attr('data-id');
        let container = $(this).parents('.follow-container');
        let path = $(this).hasClass('follow') ? 'follow': 'unfollow';
        followOrUnfollow(container, id, path);
    });
...
updateFollowButtons = (container) => {
    container.find('span').toggleClass('on');
}